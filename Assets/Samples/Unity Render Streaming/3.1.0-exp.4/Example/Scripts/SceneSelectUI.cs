...
namespace Samples.Unity_Render_Streaming._3._1._0_exp._4.Example.Scripts
{
    ...
    internal class RenderStreamingSettings
    {
        ...
        private SignalingType _signalingType = SignalingType.WebSocket;
